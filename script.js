...
/* ===========Multiple Text Typing Animation============  */
  document.addEventListener('DOMContentLoaded', () => {
    const texts = ['Front-End Developer', 'QA Software Tester', 'Backend Developer', 'UI/UX Designer'];
    let index = 0;
    let charIndex = 0;
    ...
    function type() {
      if (charIndex < texts[index].length) {
        ...
        setTimeout(erase, 2000); // Adjust time before erasing
      }
    }
    ...
    function erase() {
      if (charIndex > 0) {
        ...
        setTimeout(type, 500); // Adjust time before typing next text
      }
    }
